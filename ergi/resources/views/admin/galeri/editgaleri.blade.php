...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
        <div>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active text-muted" aria-current="page">Edit Galeri</li>
            </ol>
        </div>
    </div>
    ...
    <form action="{{ route('galeri.update', $galeri->id_galeri) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judul" class="form-control w-100" value="{{ $galeri->judul }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group w-100">
                <input type="hidden" name="foto_url" id="foto_url" value="{{ asset('ufiles/'.$galeri->foto) }}">
                <input type="text" name="foto" id="foto" class="form-control" value="{{ $galeri->foto }}">
            ...
            <div class="mt-3">
                @if($galeri->foto)
                    <img id="previewImage" src="{{ asset('ufiles/'.$galeri->foto) }}" alt="Preview"
