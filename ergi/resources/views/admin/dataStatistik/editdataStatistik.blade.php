...
@section('title', 'Edit Kategori Statistik')
...
<div class="bg-white rounded-lg shadow-md p-6">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
    <div>
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active text-muted" aria-current="page">Edit Kategori</li>
      </ol>
    </div>
  </div>

  {{-- Judul --}}
  <h2 class="text-[#0D4715] text-center text-2xl font-bold mb-4">Edit Kategori Statistik</h2>
  ...
  {{-- Form Edit Kategori Statistik --}}
  <form action="{{ route('kategori-statistik.update', $kategori->id_kategori) }}" method="POST">
    @csrf
    @method('PUT')
